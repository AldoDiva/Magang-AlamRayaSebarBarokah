...
<body>
 ...
 <div class="col-md-12">
 <input id="tim" type="text" class="form-control" name="tim" value="" required autofocus>
 </div>
 {{-- Progress--}}
 <div class="form-group">
 ...
 <label for="waktu" class="col-md-12 col-form-label">Waktu</label>\
 <div class="col-md-12">\
 <input id="waktu" type="text" class="form-control" name="waktu" value="'+values.waktu+'" required autofocus>\
 </div>\
 </div>';
